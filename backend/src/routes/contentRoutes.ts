...
router.get(
  '/items',
  contentController.getUserContentItems.bind(contentController)
);
...
router.get(
  '/items/:id',
  contentController.getContentItem.bind(contentController)
);
...
router.get(
  '/items/:id/full',
  contentController.getFullProcessedContent.bind(contentController)
);
...
router.post(
  '/items',
  rateLimitMiddleware,
  contentController.createContentItem.bind(contentController)
);
...
router.put(
  '/items/:id',
  contentController.updateContentItem.bind(contentController)
);
...
router.delete(
  '/items/:id',
  contentController.deleteContentItem.bind(contentController)
);
...
router.post(
  '/items/:id/processed',
  contentController.markAsProcessed.bind(contentController)
);
