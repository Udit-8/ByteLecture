...
router.post(
  '/sets/:id/share',
  quizController.generateShareLink.bind(quizController)
);
router.get(
  '/shared/:shareId',
  quizController.accessSharedQuiz.bind(quizController)
);

// Quiz sets by content item
router.get(
  '/content/:contentItemId',
  quizController.getQuizSetsByContentItem.bind(quizController)
);

// Quiz attempts
router.post(
  '/sets/:quizSetId/attempts',
  quizController.submitQuizAttempt.bind(quizController)
);
router.get(
  '/sets/:quizSetId/attempts',
...
router.get(
  '/analytics',
  quizController.getUserPerformanceAnalytics.bind(quizController)
);
router.get(
  '/content/:contentItemId/performance',
  quizController.getContentPerformance.bind(quizController)
);
